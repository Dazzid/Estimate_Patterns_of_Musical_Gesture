...
def evaluate_model(trainX, trainy, testX, testy, param):
    ...
    tf.keras.utils.plot_model(model, show_shapes=False, show_layer_names=True, to_file='figures/CNN_Standarization.png')
...
def summarize_results(scores, params):
    ...
    pyplot.savefig('figures/exp_cnn_standardize.png')
